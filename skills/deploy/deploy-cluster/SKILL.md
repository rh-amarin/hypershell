...
env:
  - name: GATEWAY_IMAGE
    value: quay.io/opendatahub/odh-openshell-gateway:v0.0.113-rhaiv.2@sha256:6af...
  - name: GATEWAY_SUPERVISOR_IMAGE
    value: quay.io/opendatahub/odh-openshell-supervisor:v0.0.113-rhaiv.2@sha256:f72...
```
